// Pain/injury signal. Branch 1 matches pain words directly, INCLUDING the past
// and adnominal conjugations of 아프다 (아팠어/아픈데/아픔) — the bare-stem form
// alone missed "무릎이 좀 아팠어" in QA, leaving no safety disclaimer. Branch 2
// catches "<body part> ... 아/통/삐/결" and tolerates an intervening adverb
// (좀/많이/조금) between the part and the pain word.
const PAIN_PATTERN =
  /(아프|아파|아팠|아픈|아픔|통증|부상|삐|결림|결려|쑤시)|((허리|무릎|어깨|목|손목|발목|팔꿈치)\s*(가|이|을|를)?\s*(\S+\s+)?(아|통|삐|결))/;
